      ...
      <v-row>
        ...
        <v-col cols="12" xs='9' sm='9' md='6' lg='4'>
          <v-card class="pa-5 mb-5">
              <v-card-title class="main-blue mb-10 pa-10">
                <h1>Sign Up</h1>
              </v-card-title>
              <v-form @submit.prevent="signUpHandler" @keyup.enter="signUpHandler" ref="signUpForm" class="d-flex flex-column">
                  <v-text-field
                    outlined
                  ...
                  color="#E6AF2E"
                  dark
                  class="align-self-end pl-10 pr-10"
                  >Sign up</v-btn>
              </v-form>
          </v-card>
